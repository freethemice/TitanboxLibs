...
public class LibsFormattingTool
{
    ...
    public static String formatSuffixe(long value) {
    ...
    public static String formatLocation(Location location)
    {
        ...
        return "(World: " + LibsLocationTool.getWorldName(location) + ") " + location.getBlockX() + "," + location.getBlockY() + "," + location.getBlockZ();
    }
    ...
    public static String formatTimeFromNow(long lastping)
    {
